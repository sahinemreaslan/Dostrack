...
"""
Add default config for DOSTrack (DINO-based Object Tracking).
"""
cfg = edict()
...
cfg.MODEL.BACKBONE.FROZEN = True  # Whether to freeze backbone weights
cfg.MODEL.BACKBONE.USE_LORA = False  # Whether to use LoRA fine-tuning
cfg.MODEL.BACKBONE.LORA_RANK = 4  # LoRA rank parameter
cfg.MODEL.BACKBONE.LORA_ALPHA = 1.0  # LoRA alpha scaling parameter
